...
if __name__ == "__main__":
    ...
    s = fe.get_similar_words("appeared",5)
    print("Similar words are: " + ''.join([ss for ss in s]))

    data = json.loads(open('/home/pooja/Downloads/NLPCode/event_detection.data.sample.json').read())
#    data = json.load('/home/pooja/Downloads/NLPCode/event_detection.data.sample.json').decode('utf-8-sig')
