...
class Trainer():
    ...
    def train_normal(self, config):
        ...
        # x_relType = np.array([dd[6] for d in data for dd in d])
        ...
        for e in range(1, config.epochs+1):
            ...
            if e%5 == 0:
                ...
                # with open(r"C:\Users\pkosala\Downloads\event_detection_BiLSTM2\Output\testing_upsampling_{}.res".format(e), 'w', encoding='utf-8') as outfile:
...
def train_model():
    ...
    #glove_path = r"C:\Users\krish\OneDrive\Desktop\NLP project code\Glove\glove.6B.300d"
    glove_path = r"C:\Users\pkosala\Downloads\Glove\Glove\glove.6B.300d"
    #glove_path = ""  # glove.6B.300d"

    #data_path = ""#event_detection.data.filter.json
    data_path = r"C:\Users\pkosala\Downloads\Glove\event_detection.data.sample.json"  # event_detection.data.filter.json
